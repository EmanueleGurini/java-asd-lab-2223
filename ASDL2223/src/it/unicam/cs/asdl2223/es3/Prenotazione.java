...
public class Prenotazione implements Comparable<Prenotazione> {
    ...
    public Prenotazione(String aula, TimeSlot timeSlot, String docente,
        ...
        if (aula == null || timeSlot== null || docente== null || motivo == null) {
            throw new NullPointerException("Please, all input should be filled.");
        }
        this.aula = aula;
    ...
    public boolean equals(Object obj) {
        ...
        if(!this.aula.equals(o.aula) || !this.timeSlot.equals(o.timeSlot)) {
            return false;
        }
    ...
    public int compareTo(Prenotazione o) {
       int cmpResult = this.timeSlot.compareTo(o.timeSlot);
       if(cmpResult != 0) {
           return cmpResult;
       }
