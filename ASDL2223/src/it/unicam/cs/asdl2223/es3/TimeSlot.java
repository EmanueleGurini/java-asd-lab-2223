...
public class TimeSlot implements Comparable<TimeSlot> {
    ...
    public int compareTo(TimeSlot o) {
        if(o == null) throw new NullPointerException("O shuld not be null");

        int cmpResult = this.start.compareTo(o.start);

        if(cmpResult != 0) {
            return cmpResult;
        };

        cmpResult = this.stop.compareTo(o.stop);
    ...
    public String toString() {
        ...
        sb.append("[")
                .append(start.get(Calendar.DAY_OF_MONTH)).append("/")
                .append(start.get(Calendar.MONTH) + 1).append("/")
                .append(start.get(Calendar.YEAR)).append(" ")
                .append(start.get(Calendar.HOUR_OF_DAY)).append(".")
                .append(start.get(Calendar.MINUTE)).append(" - ")
                .append(stop.get(Calendar.DAY_OF_MONTH)).append("/")
                .append(stop.get(Calendar.MONTH) + 1).append("/")
                .append(stop.get(Calendar.YEAR)).append(" ")
                .append(stop.get(Calendar.HOUR_OF_DAY)).append(".")
                .append(stop.get(Calendar.MINUTE)).append("]");
        return sb.toString();
    }
